...
public class UpdateHandler : IUpdateHandler
{
    ...
    public UpdateHandler(ITelegramBotClient botClient, ILogger<UpdateHandler> logger, ITelegramService telegramService)
    {
    ...
    private async Task BotOnMessageReceived(Message message, CancellationToken cancellationToken)
    {
        ...
        {
            "/start" => StartedBot(_botClient, message, cancellationToken, this),
            "شناسه چت من" => GetChatId(_botClient, message, cancellationToken),
        ...
        //start
        static async Task<Message> StartedBot(ITelegramBotClient botClient, Message message,
            CancellationToken cancellationToken, UpdateHandler updateHandler)
        {
            ...
            await updateHandler._telegramService.RegisterUserFromTelegram(new AddUserFromTelegramDto()
            {
               FirstName = "!23",
               LastName = "123",
               ChatId = message.Chat.Id
            ...
            InlineKeyboardMarkup inlineKeyboard = new(
                new[]
                {
                    ...
                    new[]
                    {
                        InlineKeyboardButton.WithCallbackData("شناسه چت من"),
                        InlineKeyboardButton.WithCallbackData(message!.Text!, message!.Text!),
                    },
                });
            ...
            return await botClient.SendTextMessageAsync(
                chatId: message.Chat.Id,
                text: "سلام خوش آمدید " +
                      "شناسه چت شما :" + message.Chat.Id,
                replyMarkup: inlineKeyboard,
                cancellationToken: cancellationToken);
        }
        
        //get chatId
        static async Task<Message> GetChatId(ITelegramBotClient botClient, Message message,
            CancellationToken cancellationToken)
        {
            await botClient.SendChatActionAsync(
                chatId: message.Chat.Id,
            ...
            return await botClient.SendTextMessageAsync(
                chatId: message.Chat.Id,
                text: "شناسه چت شما :" + message.Chat.Id,
                cancellationToken: cancellationToken);
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            InlineKeyboardMarkup inlineKeyboard = new(
                new[]
                {
                    ...
                    new[]
                    {
                        InlineKeyboardButton.WithCallbackData("1.1", message.Chat.Id.ToString()),
            ...
            CancellationToken cancellationToken)
        {
            const string usage = "Usage:\n" +
                                 ...
                                 "شناسه چت من - نمایش شناسه چت شما";
