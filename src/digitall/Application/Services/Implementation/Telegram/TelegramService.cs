        ...
        if (appleIdTypes.Count < 1)
            ...
            await botClient!.EditMessageTextAsync(
                ...
                text: """
                      ...
                      برای بررسی دقیق‌تر در گوشی آیفون، می‌توانید به قسمت App Store بروید، سپس به Account Settings و از آنجا به Purchase History رفته و در قسمت "Showing" گزینه "Data Range" را انتخاب کنید. گزینه Custom را انتخاب کنید و سال‌هایی که اپل آیدی شما فعال بوده را مشاهده کنید. 
                      ...
                      """,
                replyMarkup: TelegramHelper.CreateListAppleIdTypeTemplateButton(appleIdTypes),
                cancellationToken: cancellationToken);
    }
